...
MIN_BALANCE_TO_LEFT = 30  # min amount to left on the balance, if 0, it is traded until the balance is equal to 0.

TRADE_AMOUNT = [25, 40]  # (works nearly from +-20%), minimum (5$) and maximum amount to trade in USD, if 0 it will trade on FULL balance
